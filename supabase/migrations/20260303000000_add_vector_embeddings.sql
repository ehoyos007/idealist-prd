-- ============================================================
-- Add vector embeddings support for semantic search (Voyage AI)
-- ============================================================

-- 1. Enable pgvector extension
CREATE EXTENSION IF NOT EXISTS vector WITH SCHEMA extensions;

-- 2. Add nullable embedding column (voyage-3-large outputs 1024 dimensions)
...
CREATE INDEX idx_prd_document_chunks_embedding
ON public.prd_document_chunks
